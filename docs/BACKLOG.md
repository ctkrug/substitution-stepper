...
- [ ] **1.1 Wow moment: define, call, and step factorial to completion**
...
- [ ] **1.2 Environment model with lexical scoping**
...
- [ ] **1.3 Step-capturing evaluator for core special forms**
...
- [ ] **1.4 Back/rewind and full history scrubbing**
...
- [ ] **1.5 Design polish: chalkboard board rendering**
...
- [ ] **2.1 Code input with paste/load and example library**
...
- [ ] **2.2 Inline error reporting for parse and runtime failures**
...
- [ ] **2.3 Design polish: error and empty states**
...
- [ ] **3.1 Step controls: forward, back, play/auto-step, reset**
...
- [ ] **3.2 Keyboard and touch control parity**
...
- [ ] **3.3 Synth SFX with persisted mute**
...
- [ ] **3.4 Design polish: responsive composition at 390 / 768 / 1440**
...
- [ ] **4.1 Static build & subpath deploy readiness**
...
- [ ] **4.2 Test coverage for the evaluator's core reduction rules**
